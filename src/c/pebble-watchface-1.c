...
static void main_window_load(Window *window) {
  ...
  s_background_bitmap = gbitmap_create_with_resource(RES_BG);
  ...
  s_time_font = fonts_load_custom_font(resource_get_handle(RES_TIME_FN));
  s_date_font = fonts_load_custom_font(resource_get_handle(RES_DATE_FN));
